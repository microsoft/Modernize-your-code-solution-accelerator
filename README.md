...
This solution architecture is the default solution architecture with the default setting of our deployment process. Optionally you can deploy [Well-Architected Framework (WAF) aligned](https://learn.microsoft.com/en-us/azure/well-architected/) architecture, described in [WAF Aligned Solution Architecture](./docs/ArchitectureWAF.md), with deployment the WAF-Aligned option described in [Deployment Guide](./docs/DeploymentGuide.md).
