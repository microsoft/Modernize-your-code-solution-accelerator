metadata name = 'Modernize Your Code Solution Accelerator - Bicep Custom Flavor'
metadata description = 'Thin bicep custom flavor wrapper that preserves the flavor-specific entrypoint and delegates to the shared implementation.'
...
module implementation '../avm/main_custom.bicep' = {
  name: take('module.bicep.custom.shared.${solutionName}', 64)
  params: {
...
output AZURE_CONTAINER_REGISTRY_ENDPOINT string = implementation.outputs.AZURE_CONTAINER_REGISTRY_ENDPOINT
