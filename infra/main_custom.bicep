...
module orchestrator './bicep/main_custom.bicep' = {
  name: 'bicep-orchestrator-custom'
  params: {
...
output resourceGroupName string = orchestrator.outputs.resourceGroupName
output WEB_APP_URL string = orchestrator.outputs.WEB_APP_URL
output COSMOSDB_ENDPOINT string = orchestrator.outputs.COSMOSDB_ENDPOINT
output AZURE_BLOB_ACCOUNT_NAME string = orchestrator.outputs.AZURE_BLOB_ACCOUNT_NAME
output AZURE_BLOB_ENDPOINT string = orchestrator.outputs.AZURE_BLOB_ENDPOINT
...
output AZURE_CLIENT_ID string = orchestrator.outputs.AZURE_CLIENT_ID
output AZURE_AI_AGENT_MODEL_DEPLOYMENT_NAME string = orchestrator.outputs.AZURE_AI_AGENT_MODEL_DEPLOYMENT_NAME
output AZURE_BLOB_CONTAINER_NAME string = orchestrator.outputs.AZURE_BLOB_CONTAINER_NAME
output COSMOSDB_DATABASE string = orchestrator.outputs.COSMOSDB_DATABASE
output COSMOSDB_BATCH_CONTAINER string = orchestrator.outputs.COSMOSDB_BATCH_CONTAINER
output COSMOSDB_FILE_CONTAINER string = orchestrator.outputs.COSMOSDB_FILE_CONTAINER
output COSMOSDB_LOG_CONTAINER string = orchestrator.outputs.COSMOSDB_LOG_CONTAINER
output APPLICATIONINSIGHTS_CONNECTION_STRING string = orchestrator.outputs.APPLICATIONINSIGHTS_CONNECTION_STRING
output MIGRATOR_AGENT_MODEL_DEPLOY string = orchestrator.outputs.MIGRATOR_AGENT_MODEL_DEPLOY
output PICKER_AGENT_MODEL_DEPLOY string = orchestrator.outputs.PICKER_AGENT_MODEL_DEPLOY
output FIXER_AGENT_MODEL_DEPLOY string = orchestrator.outputs.FIXER_AGENT_MODEL_DEPLOY
output SEMANTIC_VERIFIER_AGENT_MODEL_DEPLOY string = orchestrator.outputs.SEMANTIC_VERIFIER_AGENT_MODEL_DEPLOY
output SYNTAX_CHECKER_AGENT_MODEL_DEPLOY string = orchestrator.outputs.SYNTAX_CHECKER_AGENT_MODEL_DEPLOY