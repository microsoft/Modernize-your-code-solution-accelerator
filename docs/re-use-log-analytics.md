[← Back to *LOCAL_DEPLOYMENT* guide](../docs/DeploymentGuide.md)
...
Proceed with the next steps in the [Chat with your data local deployment guide](../docs/DeploymentGuide.md).
